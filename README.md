...
2. [Самооценка](course/module-1-why-ai/03-diagnostics.md) — определите свой текущий уровень (5 мин)
...
- [Самооценка уровня](course/module-1-why-ai/03-diagnostics.md)
...
- [Повторная самооценка](course/module-1-why-ai/03-diagnostics.md) — сравните с результатом в начале
...
Пройдите [самооценку](course/module-1-why-ai/03-diagnostics.md), чтобы узнать свой уровень.
