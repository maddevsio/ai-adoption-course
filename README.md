...
### Модуль 9. Завершение и самопроверка `30 мин`

Финальный тест, свод правил, повторная самооценка.

- [Финальный тест](course/module-9-final/final-test.md) — 10 сценарных вопросов по всем модулям
- [DOs and DON'Ts](course/module-9-final/dos-and-donts.md) — свод правил из всех модулей
