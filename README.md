...
> **Этот курс бесполезен без практики.** Каждый модуль содержит практические задания — именно они формируют навык. Просто прочитать теорию = не пройти курс. Выделите время на практику в своём реальном проекте.

## С чего начать

1. [Введение в курс](course/module-0-intro/theory.md) — формат, ожидания, как проходить
2. [Самооценка](course/module-1-why-ai/04-diagnostics.md) — определите свой текущий уровень (5 мин)
...
- [Самооценка уровня](course/module-1-why-ai/04-diagnostics.md)
...
**Теория:**
- [Уровни зрелости использования ИИ](course/module-1-why-ai/01-levels.md)
- [8 уровней по Стиву Йегге](course/module-1-why-ai/03-yegge-levels.md)
- [Самодиагностика](course/module-1-why-ai/04-diagnostics.md)
...
### Модуль 9. Агентность разработчика `30 мин`

Кодер vs инженер, ownership, работа с неопределённостью, верификация, T-shaped навыки, флит-методология.

**Теория:**
- [Кодер vs инженер](course/module-9-agency/theory/01-coder-vs-engineer.md)
- [Антипаттерны](course/module-9-agency/theory/02-antipatterns.md)
- [Агентность](course/module-9-agency/theory/03-agency.md)
- [Неопределённость](course/module-9-agency/theory/04-uncertainty.md)
- [Верификация](course/module-9-agency/theory/05-verification.md)
- [T-shaped специалист](course/module-9-agency/theory/06-t-shaped.md)
- [Человек — боттлнек](course/module-9-agency/theory/07-human-bottleneck.md)
- [Флит-методология](course/module-9-agency/theory/08-fleet-methodology.md)
- [AI как катализатор](course/module-9-agency/theory/09-ai-as-catalyst.md)

**Практика:**
- [Зеркало антипаттернов](course/module-9-agency/practice/01-antipatterns-mirror.md)
- [Чеклист агентности](course/module-9-agency/practice/02-agency-checklist.md)

### Модуль 10. Завершение и самопроверка `30 мин`

Финальный тест, свод правил, повторная самооценка.

- [Финальный тест](course/module-10-final/final-test.md) — 10 сценарных вопросов по всем модулям
- [DOs and DON'Ts](course/module-10-final/dos-and-donts.md) — свод правил из всех модулей
- [Повторная самооценка](course/module-1-why-ai/04-diagnostics.md) — сравните с результатом в начале
...
Пройдите [самооценку](course/module-1-why-ai/04-diagnostics.md), чтобы узнать свой уровень.
