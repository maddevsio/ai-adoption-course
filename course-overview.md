...
**Сквозной пример — реальный проект.** Вместо учебных примеров курс ссылается на Enji Fleet. Каждый модуль ссылается на практики из этого проекта. Однако исходный код не раскрывается
