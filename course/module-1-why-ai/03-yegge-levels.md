...
В отличие от нашей 5-уровневой модели (→ [01-levels.md](./01-levels.md)), модель Йегге фокусируется не на навыках разработчика, а на **инструментальном прогрессе** — как меняется интерфейс взаимодействия с ИИ и степень автономности агента.
...
- **Йегге 1 (Почти без ИИ)** → Наша 1–2 (Чат + Копилот). Йегге объединяет в один уровень.
- **Йегге 2 (Агент с подтверждениями)** → Наша 2–3 (Копилот → Agentic). У нас акцент на навыках, у Йегге на UI.
- **Йегге 3 (YOLO-режим)** → Наша 3 (Agentic developer). Совпадают.
- **Йегге 4 (Широкий агент)** → Наша 3–4 (Agentic → Продвинутый). Йегге выделяет смену интерфейса.
- **Йегге 5 (CLI одиночный)** → Наша 4 (Продвинутый Agentic). Совпадают.
- **Йегге 6 (CLI мульти-агент)** → Наша 5 (Оркестратор, начало). Совпадают.
- **Йегге 7 (10+ агентов вручную)** → Наша 5 (Оркестратор). Йегге разделяет ручной и автоматический этапы.
- **Йегге 8 (Свой оркестратор)** → За Уровнем 5. Йегге детализирует "путь дальше".

**Различие:** наша модель описывает **компетенции разработчика**, модель Йегге — **эволюцию инструмента**.
---

[← Скилл матрица по уровням](02-skill-matrix.md) | [Оглавление](../../README.md) | [Самодиагностика: определите свой уровень →](04-diagnostics.md)
