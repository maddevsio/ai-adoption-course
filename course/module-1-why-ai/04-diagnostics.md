...
> [!TIP] Загрузите эту страницу в AI-агента (Claude Code, Cursor, ChatGPT) и попросите его провести диагностику в формате интервью. Агент задаст вопросы один за другим и определит ваш уровень.
