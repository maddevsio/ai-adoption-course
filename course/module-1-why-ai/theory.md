...
2. Управляйте контекстом: создавайте артефакты проекта (конституция, memory, guidelines), которые агент может переиспользовать между сессиями.
...
**Что это:** Вы используете одного мощного агента как основной интерфейс для разработки, расширив его возможности через MCP и выстроив процесс на основе спецификаций. Агент работает автономнее, потому что вы даёте ему чёткие правила, примеры и инструменты.
...
- Понять Ralph Loop — цикл агентной разработки
