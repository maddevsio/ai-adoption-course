...
**Ссылка:** [https://gandalf.lakera.ai/intro](https://gandalf.lakera.ai/intro)
...
**Шаг 1: Начните игру**
1. Перейдите на [https://gandalf.lakera.ai/intro](https://gandalf.lakera.ai/intro)
2. Начните с Level 1
...
**1. ИИ следует паттернам, а не правилам.** Инструкции для ИИ — не код с чёткой логикой. ИИ "понимает" контекст статистически. Всегда есть способ обойти ограничение.

**2. Граница между "разрешено" и "запрещено" размыта.** Достаточно изменить формулировку, чтобы получить тот же результат. Защита через промпт-инструкции ненадёжна.

**3. Креативность в промптинге — это навык.** Чем больше экспериментируете, тем лучше чувствуете "мышление" модели.

---

[← Упражнение 2: Промпты для разных задач (15 мин)](02-prompt-templates.md) | [Оглавление](../../../README.md) | [Модуль 4: Работа с AI-агентом →](../../module-4-agents/theory/01-agent-fundamentals.md)
