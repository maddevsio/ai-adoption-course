...
Few-shot обходит проблему формализации правил. Вместо описания «создавай индексы для FK, используй ondelete, всегда пиши downgrade» — показываете примеры.
...
Одношаговый промпт приводит к поверхностным решениям. Chaining воспроизводит процесс: понять → спланировать → реализовать → протестировать.
