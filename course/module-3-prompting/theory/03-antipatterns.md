...
> [!TIP]
> Если лень писать детальный промпт — используйте skills (`/writing-plans`, `/debugging` и прочие). Они заставляют агента задавать уточняющие вопросы, если что-то непонятно. Это экономит время лучше, чем угадывать в спешке.
---
