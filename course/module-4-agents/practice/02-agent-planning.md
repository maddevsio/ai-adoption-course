...
Научиться правильно формулировать задачу для агента-планировщика. Получить детализированный план реализации с критериями приёмки.
...
Поищите в плане ссылки на технологии, conventions или правила из AGENTS.md. Например, если указано "использовать async/await", план должен содержать "async def" для endpoints.
...
4. Проверьте план по чеклисту
5. Дополните план (попросите добавить детали по тестам и линтеру)
6. Утвердите финальный план
...
[← Создай AGENTS.md для проекта](01-create-agents-md.md) | [Оглавление](../../../README.md) | [Реализация и ревью результата →](03-review-result.md)
