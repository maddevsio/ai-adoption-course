...
metadata:
  annotations:
    ...
    run.googleapis.com/operation-id: dc57f0ee-6635-4ced-b0f3-b72491734015
    run.googleapis.com/urls: '["https://app-backend-dev-43738194868.us-central1.run.app","https://app-backend-dev-lurmm2fjba-uc.a.run.app"]'
    serving.knative.dev/creator: gha-account@happyverse.iam.gserviceaccount.com
    serving.knative.dev/lastModifier: gha-account@happyverse.iam.gserviceaccount.com
  creationTimestamp: '2025-06-06T00:20:47.977087Z'
  generation: 550
  labels:
    cloud.googleapis.com/location: us-central1
  name: app-backend-dev
  namespace: '43738194868'
  resourceVersion: AAZK8FPTx5U
  selfLink: /apis/serving.knative.dev/v1/namespaces/43738194868/services/app-backend-dev
  uid: 813cdbe1-855b-4614-8433-5a270435f0d8
spec:
  template:
    metadata:
      annotations:
        ...
        run.googleapis.com/vpc-access-connector: projects/happyverse/locations/us-central1/connectors/vpc-default
        run.googleapis.com/vpc-access-egress: private-ranges-only
      labels:
        client.knative.dev/nonce: foqeogasvu
        run.googleapis.com/startupProbeType: Default
    spec:
      containerConcurrency: 30
      containers:
        image: gcr.io/happyverse/app-backend-dev:f9d33cdc50b1a3149ad171acfd8cc56120d8a155
        name: app-backend-dev-1
        ports:
        - containerPort: 8000
          name: h2c
        resources:
        ...
        startupProbe:
          ...
          tcpSocket:
            port: 8000
          timeoutSeconds: 240
      serviceAccountName: 43738194868-compute@developer.gserviceaccount.com
      timeoutSeconds: 1000
  traffic:
  - revisionName: app-backend-dev-00136-56w
    tag: good
  - latestRevision: true
    percent: 100
status:
  address:
    url: https://app-backend-dev-lurmm2fjba-uc.a.run.app
  conditions:
  - lastTransitionTime: '2026-02-16T12:45:19.258517Z'
    status: 'True'
    type: Ready
  - lastTransitionTime: '2026-02-16T12:44:34.812786Z'
    status: 'True'
    type: ConfigurationsReady
  - lastTransitionTime: '2026-02-16T12:45:19.206898Z'
    status: 'True'
    type: RoutesReady
  latestCreatedRevisionName: app-backend-dev-00540-76d
  latestReadyRevisionName: app-backend-dev-00540-76d
  observedGeneration: 550
  traffic:
  - revisionName: app-backend-dev-00136-56w
    tag: good
    url: https://good---app-backend-dev-lurmm2fjba-uc.a.run.app
  - latestRevision: true
    percent: 100
    revisionName: app-backend-dev-00540-76d
  url: https://app-backend-dev-lurmm2fjba-uc.a.run.app