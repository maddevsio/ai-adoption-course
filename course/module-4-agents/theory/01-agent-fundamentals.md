...
### 4.1. Сравнение инструментов: файлы конфигурации агента

| Инструмент | Файл-конституция | Конфигурация | Режим планирования |
|------------|-----------------|--------------|-------------------|
| Claude Code | `CLAUDE.md` | `~/.claude/` | `/plan` |
| Cursor | `.cursorrules` | `.cursor/` | Composer |
| OpenCode | `AGENTS.md` | `.opencode/` | — |

Суть одна — правила работы агента с проектом. Если вы переходите между инструментами, содержимое конституции переносимо — меняется только имя файла.
