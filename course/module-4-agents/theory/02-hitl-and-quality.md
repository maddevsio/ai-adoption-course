...
Обобщая, агент может работать в двух режимах взаимодействия:
...
LLM генерирует код, который "выглядит правильно", но модель может пропустить баги, дыры в безопасности, нарушения конвенций.

Решение: **интегрировать детерминистические инструменты в workflow агента**. 
- линтеры 
- type checkers
- тесты 
- security scanner
