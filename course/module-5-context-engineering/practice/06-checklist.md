...
- **Не повторяйте паттерн** — если делаете что-то третий раз, сделайте из этого скилл или документ. LLM переиспользует инструкции, а вы не тратите время на повторные объяснения
...
[← Шаг 4: Заметки по реализации (5 мин)](05-trace.md) | [Оглавление](../../../README.md) | [Модуль 6: Model Context Protocol (MCP) →](../../module-6-mcp/theory/01-what-is-mcp.md)
