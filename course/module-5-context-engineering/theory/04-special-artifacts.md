...
Skills позволяют автоматизировать повторяющиеся workflow и специализировать агентов на конкретные задачи. Каждый skill — это готовый промпт с чёткими инструкциями.
