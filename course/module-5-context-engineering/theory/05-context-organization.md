...
Агент оптимизирован на скорость решения задачи, а не качество. Чем конкретнее требование, тем выше вероятность его качественного выполнения.
...
**Уровень 3:** AGENTS.md + traces. Агент имеет доступ к тематическим файлам. Подходит для средних проектов (5-10K строк кода).
...
3. **Создайте первую спецификацию** для следующей фичи. Потратьте 15 минут на чёткое описание вместо 2 часов на объяснение агенту.
