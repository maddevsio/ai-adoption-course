...
Кодинг остаётся там, где агенты не справляются: сложная бизнес-логика без чёткой спецификации, интеграции с недокументированными API, архитектурные решения, отладка нетривиальных багов. Но объём ручного кодинга снижается.
