...
Ralph Loop работает, когда критерии успеха формализованы и автоматически проверяемы. Если критерий "код должен выглядеть красиво" — агент не поймёт, когда остановиться. Если критерий "все тесты пройдены, coverage > 80%" — агент знает, что делать.
