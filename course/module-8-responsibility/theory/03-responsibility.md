...
> [Диаграмма: Ответственность по уровням (Level 1 -> 2 -> 3 -> 4 -> 5)](../diagrams/responsibility-by-level.md)
...
#### **Уровень 1: чат-помощник**

Вы копируете код из ChatGPT / Claude.ai в свой проект. Ответственность минимальна по масштабу, но принцип тот же: скопированный код — ваш код. Проверяйте, что копируете, особенно если это касается безопасности или работы с данными.

#### **Уровень 2: копилот**

IDE-копилот (GitHub Copilot, Codeium) автодополняет код в реальном времени. Вы принимаете или отклоняете каждое предложение. Ответственность — внимательно читать предложения, а не принимать на автомате. Типичная ошибка: принять автодополнение с захардкоженным секретом или устаревшим API.
