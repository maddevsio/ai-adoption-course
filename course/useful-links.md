...
- [Skill Creator (Anthropic)](https://github.com/anthropics/skills/blob/main/skills/skill-creator/SKILL.md) — официальный skill для создания skills
- [Claude HUD](https://github.com/jarrodwatts/claude-hud) — статусбар для Claude Code
- [GSD (Get Shit Done)](https://github.com/gsd-build/get-shit-done) — workflow-фреймворк для Claude Code
...
- **PostgreSQL** — [modelcontextprotocol/servers-archived/postgres](https://github.com/modelcontextprotocol/servers-archived/tree/main/src/postgres)
- **Puppeteer** — [modelcontextprotocol/servers-archived/puppeteer](https://github.com/modelcontextprotocol/servers-archived/tree/main/src/puppeteer)
...
- [TrendShift](https://trendshift.io/github-trending-repositories) — трекер трендовых GitHub-репозиториев
