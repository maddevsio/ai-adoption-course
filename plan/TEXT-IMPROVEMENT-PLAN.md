...
#### module-1 (01-levels.md, 239 строк → цель: 150-170 строк)
...
### Пример 3: module-1, 01-levels.md, блоки "Переход на следующий уровень"
...
|-----------|-------|-------|-------------------|
| 1 | `module-1/01-levels.md` | 239 | S1, S2, S5, S6 — шаблонность, копипаста, фиктивные персонажи |
