...
| **4** | **PostgreSQL MCP** | Natural language queries, анализ данных, автогенерация миграций — практические навыки работы с БД через AI | 🟠 Важный |

### Дополнительные 2-3 сервера для продвинутых студентов

| № | Сервер | Use Case | Приоритет |
|---|--------|----------|-----------|
| **5** | **Figma MCP** | Design-to-code workflow, фронтенд-разработка | 🟡 Опциональный |
...
- PostgreSQL MCP: работа с данными
- Figma/Puppeteer MCP (на выбор)
